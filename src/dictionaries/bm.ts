export const bm = {
  nav: {
    ...
    loanbuddyApp: "Aplikasi Loanbuddy Credit",
    payment: "Pembayaran",
  ...
  applyForm: {
    ...
    valAgeRange: "Umur mestilah di antara 18 hingga 60 tahun.",
  ...
  uploadDoc: {
    ...
    formHeaderSuccess: "Permohonan Telah Berjaya Dihantar!",
    formHeaderNote:
      "Nota: Untuk menyokong lagi permohonan anda, anda boleh memuat naik dokumen pilihan yang berikut. Walaupun ia tidak wajib, dokumen tersebut dapat membantu dalam kerja pemprosesan. Tekan Skip jika anda memilih untuk tidak memuat naik sebarang dokumen.",
    appIdLabel: "ID Permohonan",
    appIdPlaceholder: "ID permohonan",
    appIdRequired: "Ruangan ini diperlukan",
    appIdInvalid:
      "ID Permohonan Tidak Sah. Sila semak sama ada terdapat kesilapan ejaan atau perbezaan huruf besar dan kecil.",
    myKadLabel: "Salinan MyKad (Pilihan)",
    supportDocLabel: "Penyata Gaji / Bank / KWSP Terkini (Pilihan)",
    uploadBtn: "Muat Naik",
    fileSizeError: "Fail mestilah kurang daripada 10MB",
    fileFormatError: "Hanya fail PDF, PNG, JPG, atau JPEG dibenarkan",
    atLeastOneRequired: "Sila muat naik sekurang-kurangnya satu fail.",
    submitBtn: "Hantar",
    submittingBtn: "Sedang memuat...",
    skipBtn: "Skip",
    uploadSuccessTitle: "Dokumen berjaya dimuat naik!",
    uploadSuccessDesc:
      "Terima kasih dan kami akan menghubungi anda dalam masa terdekat.",
    uploadFailedMsg:
      "Muat naik gagal. Sila Reload halaman dan cuba sekali lagi.",
    processingMsg: "Sila tunggu sebentar, dokumen sedang dimuat naik...",
  },
  home: {
    ...
    banner2Subheading:
      "Permohonan pinjaman peribadi kini lebih pantas dan mudah.\nMuat turun aplikasi kami sekarang untuk memohon pada\nbila-bila masa, di mana jua.",
  ...
  pinjamanPeribadiPage: {
    ...
    heroCta: "Mohon Sekarang",
    usp1: "Kadar faedah 1.5% sebulan atau 18% setahun (tetap)",
    usp2: "Amaun pinjaman dari RM1,000 sehingga RM50,000",
    usp3: "Tempoh pinjaman fleksibel dari 12 bulan sehingga 60 bulan",
    usp4: "Tidak pegang kad ATM, tiada bayaran pendahuluan",
    usp5: "Kelulusan permohonan pinjaman dalam masa 1-2 hari bekerja dan pindahan wang pada hari yang sama",
    usp6: "Pemberi pinjaman berlesen di bawah Kementerian Perumahan dan Kerajaan Tempatan (KPKT)",
  ...
  ourServicesPage: {
    ...
    reqAmountTitle: "Umur Pemohon",
    reqAmountDesc: "Pemohon yang berumur antara 18 hingga 60 tahun, mempunyai bukti kewarganegaraan Malaysia, serta bekerja dan menetap di Malaysia.",
    reqAmountDescPart1: "Pemohon yang berumur antara ",
    reqAmountMin: "18 hingga 60 tahun",
    reqAmountDescPart2: ", mempunyai bukti kewarganegaraan Malaysia, serta ",
    reqAmountMax: "bekerja dan menetap",
    reqAmountDescPart3: " di Malaysia.",
    reqJobTitle: "Keperluan Pendapatan",
    reqJobDesc: "Dengan syarat pendapatan kasar bulanan serendah RM1,700, Loanbuddy Credit menawarkan pinjaman yang mesra pelanggan dan mudah diakses di Malaysia.",
    reqAgeTitle: "Pengecualian",
    reqAgeDesc: "Pemohon tidak boleh diisytiharkan muflis atau terdedah kepada aktiviti politik. Individu yang bekerja secara bebas (freelance) juga tidak layak memohon.",
