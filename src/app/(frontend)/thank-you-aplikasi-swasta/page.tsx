...
export default function ThankYouSwastaPage() {
  return (
    <div className="bg-blue-thank-you text-white min-vh-100 d-flex flex-column justify-content-center align-items-center p-4">
      <div className="bg-white text-dark p-5 rounded-4 shadow-lg text-center max-w-lg" style={{ maxWidth: "600px" }}>
        ...
        <h5 className="mb-3 text-secondary">Permohonan Pinjaman Peribadi Swasta Anda Telah Diterima.</h5>
        <p className="text-muted mb-4">
          Pegawai kredit kami akan menyemak permohonan anda dan mengemaskini status permohonan melalui WhatsApp / telefon dalam masa singkat.
        </p>
