  ...
  return (
    <div className="page_wrapper bg-white">
      ...
      <main className="page_content">
        ...
        {/* Replaced old section_space classes with clean Tailwind padding */}
        {/* Added 'relative' to the section to anchor the absolute mascot */}
        <section className="py-12 lg:py-20 bg-white relative z-20">
          
          {/* Loanbuddy Mascot Positioned on Far Left Edge */}
          {/* 
            - top-1/2 & -translate-y-1/2 perfectly centers it vertically alongside the graph.
            - left-0 & -translate-x-[45%] pushes half of its body off the left screen edge.
          ...
          */}
          ...
          {/* Added 'relative z-10' so the content stays above the mascot */}
